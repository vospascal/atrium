...
comparison harness. We adapted the LUT path, not the full-resolution ray-marching one.
Attribution, the adapted file list and the MIT notice are in
[`THIRD_PARTY.md`](THIRD_PARTY.md). Consumers should not need to change when LUT
