...
impl GeneratorCost {
    ...
    pub const fn color(&self) -> egui::Color32 {
        match self {
            GeneratorCost::Free => egui::Color32::from_rgb(0x8b, 0x92, 0x9c),
            GeneratorCost::Cheap => egui::Color32::from_rgb(0xb4, 0xa8, 0x62),
            GeneratorCost::Moderate => egui::Color32::from_rgb(0xd0, 0x93, 0x3f),
            GeneratorCost::Expensive => egui::Color32::from_rgb(0xd2, 0x66, 0x44),
        }
    }
}
