...
impl MaterialNodeOperation {
    ...
    pub const fn tag(self) -> OperationTag {
        match self {
            ...
            Self::PatternEdgeBand => OperationTag("material.pattern_edge_band"),
            Self::Displacement => OperationTag("material.displacement"),
    ...
    fn from_label(label: &str) -> Option<Self> {
        match label {
            ...
            "material.pattern_edge_band" => Some(Self::PatternEdgeBand),
            "material.displacement" => Some(Self::Displacement),
