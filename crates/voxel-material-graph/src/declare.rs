...
//!
//! The macros are `#[macro_export]`ed, so any crate declaring a node catalogue can use them —
//! `voxel-rt`'s world family does.
//!
...
/// see [`voxel_material::pattern::PatternLayer::domain_warp`]. That is the whole reason it
...
pub const TILE_ASPECT_FIELD: FieldDeclarationStatic = field(
    ...
    Some(NumericRange::new(
        voxel_material::pattern::MINIMUM_TILE_ASPECT,
        voxel_material::pattern::MAXIMUM_TILE_ASPECT,
    )),
    Some(NumericRange::new(
        voxel_material::pattern::MINIMUM_TILE_ASPECT,
        voxel_material::pattern::MAXIMUM_TILE_ASPECT,
...
pub const TILE_GAP_FIELD: FieldDeclarationStatic = field(
    ...
    Some(NumericRange::new(
        0.0,
        voxel_material::pattern::MAXIMUM_TILE_GAP,
    )),
    Some(NumericRange::new(
        0.0,
        voxel_material::pattern::MAXIMUM_TILE_GAP,
