...
- ✅ **USED: 58** — traversal core, **the uniform-brick tag (1.12)**, analytic AO, memory packing, the E4 CAGI
  ...
  knob moves, **6.25's texel-snapped sampling and 6.26's engine-wide sub-voxel
  lattice**). (Two more are *also* used but live in section 5 under their
