...
- ✅ **USED: 60** — traversal core, **the uniform-brick tag (1.12)**, analytic AO, memory packing, the E4 CAGI
...
- 🎚️ **LEVER: 14** — all measured, all with numbers, all re-run on Quest at E9;
  the materials arc added **face roles (6.20)** and **pattern layers (6.21)**, both
